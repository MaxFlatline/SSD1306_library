...
#define OLED_SETCONTRAST_MAX 0xFE
#define OLED_SETCONTRAST_MIN 0x00

//------------------DISPLAY GDDRAM USAGE COMMANDS--------------//
#define OLED_DISPLAYALLON_RESUME 0xA4 //Force display to use GDDRAM
#define OLED_DISPLAYALLON 0xA5 //Force display to be all ON
//------------------DISPLAY GDDRAM USAGE COMMANDS--------------//
